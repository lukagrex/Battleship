...
namespace Vsite.Battleship
{
    ...
    public class TestEnemyGrid
    {
        ...
        public void GetAvailableSquaresReturns3SquaresLeftToSquare8_3OnGrid10x10()
        {
            ...
            var result = grid.GetAvailableSquares(8, 3, Direction.Left);
        ...
        {
            EnemyGrid grid = new EnemyGrid(10, 10);
            var result = grid.GetAvailableSquares(8, 3, Direction.Right);
        ...
        {
            EnemyGrid grid = new EnemyGrid(10, 10);
            var result = grid.GetAvailableSquares(8, 3, Direction.Up);
        ...
        {
            EnemyGrid grid = new EnemyGrid(10, 10);
            var result = grid.GetAvailableSquares(8, 3, Direction.Down);
            Assert.AreEqual(1, result.Count());
        }
        [TestMethod]
