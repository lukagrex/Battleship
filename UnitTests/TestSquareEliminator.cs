...
namespace Vsite.Battleship
{
    ...
    {
        [TestMethod]
        public void ToEliminateReturns18SquaresForShipInSqaures4x3_4x6()
        {
            var eliminator = new SquareEliminator(10, 10);
            var toEliminate = eliminator.ToEliminate(new List<Square> { new Square(4, 3), new Square(4, 4),
        ...
        [TestMethod]
        public void ToEliminateReturns12SquaresForShipInSqaures7x5_7x9()
        {
            var eliminator = new SquareEliminator(10, 10);
