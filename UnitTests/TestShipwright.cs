...
namespace Vsite.Battleship
{
    ...
    public class TestShipwright
    {
        ...
        {
            var shipLengths = new List<int>() { 5, 4, 4, 3, 3 };
            ...
            Assert.AreEqual(2, fleet.Ships.Count(ship => ship.Squares.Count() == 3));
            //Assert.AreEqual(4, fleet.Ships.Count(ship => ship.Squares.Count() == 2));
        }
    }
}
